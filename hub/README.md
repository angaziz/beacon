...
1. Download `Beacon-Hub-<version>-macos-apple-silicon.zip` from [Releases](https://github.com/angaziz/beacon/releases), unzip, and drag **Beacon Hub.app** to `/Applications`. If macOS blocks it on first launch, allow it via **System Settings > Privacy & Security > Open Anyway**.
