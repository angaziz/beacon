...
### 3.5b BuddyState.waiting always 0 — **P2**
`waiting` is in the protocol but never incremented (Notification hooks deliberately don't bump it). The idle telemetry line always shows `0 WAITING`.
